...
import com.gubertmc.plugin.main.mazegenerator.algorithms.greedybestfirstsearch.greedybestfirstsearch3d.diagonalmovement.GreedyBestFirstSearchAnimationDiagonal3D;
import com.gubertmc.plugin.main.mazegenerator.algorithms.greedybestfirstsearch.greedybestfirstsearch3d.diagonalmovement.GreedyBestFirstSearchSimulationDiagonal3D;
...
public class GreedyBestFirstSearchMazeDiagonal3D extends Maze3D {

    public GreedyBestFirstSearchMazeDiagonal3D(MazeGeneratorPlugin plugin, Block block, int size, double wallPercentage) {
    ...
    public void generateNewMaze(
        ...
        while (!isValid()) {
            ...
            Simulation simulation = new GreedyBestFirstSearchSimulationDiagonal3D(
            ...
            if (isValid()) {
                ...
                new BukkitRunnable() {
                    @Override
                    public void run() {
                        Animation animation = new GreedyBestFirstSearchAnimationDiagonal3D(
                                getPlugin(),
