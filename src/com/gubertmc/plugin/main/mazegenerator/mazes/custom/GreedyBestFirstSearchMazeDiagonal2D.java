...
import com.gubertmc.plugin.main.mazegenerator.algorithms.greedybestfirstsearch.greedybestfirstsearch2d.diagonalmovement.GreedyBestFirstSearchAnimationDiagonal2D;
import com.gubertmc.plugin.main.mazegenerator.algorithms.greedybestfirstsearch.greedybestfirstsearch2d.diagonalmovement.GreedyBestFirstSearchSimulationDiagonal2D;
import com.gubertmc.plugin.main.mazegenerator.mazes.Maze2D;
...
public class GreedyBestFirstSearchMazeDiagonal2D extends Maze2D {

    public GreedyBestFirstSearchMazeDiagonal2D(MazeGeneratorPlugin plugin, Block block, int size, double wallPercentage) {
    ...
    public void generateNewMaze(
        ...
        while (!isValid()) {
            ...
            Simulation simulation = new GreedyBestFirstSearchSimulationDiagonal2D(
            ...
            if (isValid()) {
                ...
                new BukkitRunnable() {
                    @Override
                    public void run() {
                        Animation animation = new GreedyBestFirstSearchAnimationDiagonal2D(
                                getPlugin(),
