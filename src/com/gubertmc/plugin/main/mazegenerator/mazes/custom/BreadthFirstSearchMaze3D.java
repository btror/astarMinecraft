package com.gubertmc.plugin.main.mazegenerator.mazes.custom;

import com.gubertmc.MazeGeneratorPlugin;
import com.gubertmc.plugin.main.mazegenerator.algorithms.Animation;
import com.gubertmc.plugin.main.mazegenerator.algorithms.Simulation;
import com.gubertmc.plugin.main.mazegenerator.algorithms.breadthfirstsearch.bfs3d.BreadthFirstSearchAnimation3D;
import com.gubertmc.plugin.main.mazegenerator.algorithms.breadthfirstsearch.bfs3d.BreadthFirstSearchSimulation3D;
import com.gubertmc.plugin.main.mazegenerator.mazes.Maze3D;
...
public class BreadthFirstSearchMaze3D extends Maze3D {

    public BreadthFirstSearchMaze3D(MazeGeneratorPlugin plugin, Block block, int size, double wallPercentage) {
    ...
    public void generateNewMaze(
        ...
        while (!isValid()) {
            ...
            Simulation simulation = new BreadthFirstSearchSimulation3D(
            ...
            if (isValid()) {
                ...
                new BukkitRunnable() {
                    @Override
                    public void run() {
                        Animation animation = new BreadthFirstSearchAnimation3D(
                                getPlugin(),
            ...
            if (count == 50) {
                getServer().broadcastMessage(
                        ChatColor.RED + "A maze could not be successfully generated within 50 simulations. " +
                                "You may experience server lag. Creating a larger maze with a lower percentage " +
                                "of walls/blockers will greatly help and put less stress on the server."
                );
            }
        }
    }
