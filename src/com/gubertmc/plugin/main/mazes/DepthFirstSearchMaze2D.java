...
public class DepthFirstSearchMaze2D extends Maze {
    ...
    public void generateNewMaze(
        ...
        while (!isValid) {
            ...
            Simulation simulation = new DepthFirstSearchSimulation2D(simulationMaze, getStartCoordinate(), getEndCoordinate());
            ...
            if (isValid) {
                ...
                new BukkitRunnable() {
                    @Override
                    public void run() {
                        Animation animation = new DepthFirstSearchAnimation2D(getPlugin(), getLocations(), getStartCoordinate(), getEndCoordinate(), getSize(), blockerMaterial, pathMaterial, spreadMaterial, coreMaterial, startPointGlassMaterial, endPointGlassMaterial, false);
