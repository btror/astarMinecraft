...
public class BreadthFirstSearchMaze2D extends Maze {
    ...
    public void generateNewMaze(
        ...
        while (!isValid) {
            ...
            Simulation simulation = new BreadthFirstSearchSimulation2D(simulationMaze, getStartCoordinate(), getEndCoordinate());
            ...
            if (isValid) {
                ...
                new BukkitRunnable() {
                    @Override
                    public void run() {
                        Animation animation = new BreadthFirstSearchAnimation2D(getPlugin(), getLocations(), getStartCoordinate(), getEndCoordinate(), getSize(), blockerMaterial, pathMaterial, spreadMaterial, coreMaterial, startPointGlassMaterial, endPointGlassMaterial, false);
